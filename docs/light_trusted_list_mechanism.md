...
- **Fake Trusted List (Endpoint Impersonation)** _Threat:_ A malicious endpoint could serve a fake trusted list._Mitigation:_
...
- **Malicious Entity Insertion** _Threat:_ A compromised backend might add fake issuers or merchants to the list._Mitigation:_
...
- **Key Compromise of Authority** _Threat:_ If the ecosystem authority’s root signing key is compromised, the entire trust model collapses._Mitigation:_
